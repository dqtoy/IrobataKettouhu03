...
namespace FullSerializer {
    ...
    /// シリアライズされた値を格納する共用体型。 格納される型は、null、boolean、double、Int64、string、DictionaryまたはListの6種類のうちの1つです。
    /// </summary>
    public sealed class fsData {
        ...
        /// このシリアル化されたデータが格納する生の値。 それは6つの異なるタイプの1つになります。 ブール値、倍精度値、Int64、文字列、ディクショナリ、またはリストです。
        /// </summary>
        ...
        /// このfsDataインスタンスがnullにマップする場合はtrueを返します。
        /// </summary>
        public bool IsNull {
            get {
                return _value == null;
        ...
        /// このfsDataインスタンスがdoubleにマップされている場合にtrueを返します。
        /// </summary>
        ...
        /// このfsDataインスタンスがInt64にマップされている場合にtrueを返します。
        /// </summary>
        public bool IsInt64 {
            get {
        ...
        /// このfsDataインスタンスがブール値にマップされている場合はtrueを返します。
        /// </summary>
        public bool IsBool {
            get {
        ...
        /// このfsDataインスタンスが文字列にマップされている場合にtrueを返します。
        /// </summary>
        ...
        /// このfsDataインスタンスが辞書にマップされている場合にtrueを返します。
        /// </summary>
        ...
        /// このfsDataインスタンスがリストにマップされている場合にtrueを返します。
        /// </summary>
        public bool IsList {
            get {
