...
{
    /// <summary>
    /// This class represents a single Token type in the game.
    /// このクラスは、ゲーム内の単一のカードタイプを表します。
    /// </summary>
    public class TokenType : Resource
    {
        /// <summary>
        ...
        /// <summary>
        /// The properties of this Token type.
        /// このカードタイプのプロパティ。
        /// </summary>
        public List<Property> properties = new List<Property>();

        /// <summary>
        /// The stats of this Token type.
        /// このカードタイプのスタッツ
        /// </summary>
        public List<DefinitionStat> stats = new List<DefinitionStat>();

        /// <summary>
        /// The destroy conditions of this Token type.
        /// このカードタイプの破壊条件。
        /// </summary>
        public List<DestroyTokenCondition> destroyConditions = new List<DestroyTokenCondition>();

        /// <summary>
        /// True if this Token should move to another zone after triggering its effect
        /// このカードが効果を発動した後に別のゾーンに移動する必要がある場合はTrue
        /// (useful for spell-like Tokens); false otherwise.
        /// （スペルのようなカードに便利です）。 そうでなければfalse。
        /// </summary>
        public bool moveAfterTriggeringEffect;

        /// <summary>
        /// The zone to which this Token should move after triggering its effect.
        ...
        /// Constructor.
        /// </summary>
        public TokenType() : base(currentId++)
        {
        }
